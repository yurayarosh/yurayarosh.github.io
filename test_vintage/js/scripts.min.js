...
$(function(){function i(){$(".hidden-mnu-links").height()>0&&($(window).width()>=768?$(".hidden-mnu-links").css({height:"75%"}):$(".hidden-mnu-links").css({height:"85%"}))}$(".lang-list1").hover(function(){$(this).find("li.hidden-list-items").slideDown()},function(){$(this).find("li.hidden-list-items").slideUp()}),$(".lang-list1 li").click(function(){$(this).removeClass("hidden-list-items"),$(this).siblings("li").addClass("hidden-list-items").slideUp()}),$(".toggle-mnu").click(function(){$(this).toggleClass("on")}),$.fn.toggleClick=function(i){return this.click(function(){var n=$(this),t=n.data("index")||0;i[t](),n.data("index",(t+1)%i.length)})},$(".toggle-mnu").toggleClick([function(){TweenMax.to($(".hidden-mnu"),1,{width:"100%"}),TweenMax.to($(".hidden-lang-list li"),.5,{css:{opacity:"1",transform:"translateX(0)",paddingRight:"10px"}}).delay(1),TweenMax.to($(".hidden-mnu-links"),1,{height:function(){if($(window).width()>=768)var i="75%";else var i="85%";return i}()}).delay(1),TweenMax.to($(".hidden-mnu-social a"),1,{css:{opacity:"1",transform:"translateX(0)",paddingRight:"10px"}}).delay(1.5)},function(){TweenMax.to($(".hidden-mnu-social a"),.5,{css:{opacity:"0",transform:"translateX(-100px)",paddingRight:"0"}});TweenMax.to($(".hidden-mnu-links"),1,{height:"0"}).delay(1),TweenMax.to($(".hidden-lang-list li"),.5,{css:{opacity:"0",transform:"translateX(-100px)",paddingRight:"0"}}).delay(.5),TweenMax.to($(".hidden-mnu"),1,{width:"0"}).delay(1.5)}]),i(),$(window).resize(function(){i()}),TweenMax.to($(".top-line"),2,{opacity:"1",top:"0"}),TweenMax.fromTo($("h1"),2,{opacity:"0",top:"50px",lineHeight:"2"},{opacity:"1",top:"0",lineHeight:"1.3"}).delay(1),TweenMax.fromTo($(".play-btn img"),.5,{width:"0",height:"0",rotation:"180"},{width:"67px",height:"78px",rotation:"0"}).delay(2),TweenMax.to($(".play-btn span"),.5,{opacity:"1",top:"0"}).delay(2.5),TweenMax.to($(".mouse-scroll"),1,{opacity:"1"}).delay(3)});